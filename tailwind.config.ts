// NOTE (Clara): Con Tailwind v4 este archivo es opcional y no es necesario.
// Tu tema ya está en `src/assets/tailwind.css` usando `@theme`.
// Puedes borrar este archivo para evitar confusiones.
